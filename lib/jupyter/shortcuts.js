define([
  ...
  exports.get_default_edit_shortcuts = function get_default_edit_shortcuts() {
    return {
      ...
      'ctrl-u': 'vim-binding:select-previous-cell',
      'ctrl-d': 'vim-binding:select-next-cell',
      'ctrl-shift-u': 'vim-binding:extend-selection-above',
      'ctrl-shift-d': 'vim-binding:extend-selection-below',
      'shift-space': 'vim-binding:scroll-notebook-up',
      'space': 'vim-binding:scroll-notebook-down',
