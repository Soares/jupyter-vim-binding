define([
  ...
  exports.get_default_command_shortcuts = function get_default_command_shortcuts() {
    return {
      ...
      'cmdtrl-shift-c': 'jupyter-notebook:change-cell-to-code',
      'cmdtrl-shift-m': 'jupyter-notebook:change-cell-to-markdown',
      'cmdtrl-shift-r': 'jupyter-notebook:change-cell-to-raw',
      ...
      'ctrl-u': 'jupyter-notebook:select-previous-cell',
      'ctrl-d': 'jupyter-notebook:select-next-cell',
      'shift-u': 'jupyter-notebook:extend-selection-above',
      'shift-d': 'jupyter-notebook:extend-selection-below',
      'ctrl-shift-u': 'jupyter-notebook:extend-selection-above',
      'ctrl-shift-d': 'jupyter-notebook:extend-selection-below',
      // 'shift-space': 'vim-binding-normal:scroll-notebook-up',
      // 'space': 'vim-binding-normal:scroll-notebook-down',
      // 'ctrl-shift-space': 'vim-binding-normal:scroll-notebook-up',
      // 'ctrl-space': 'vim-binding-normal:scroll-notebook-down',
      // Onetime operations
  ...
  exports.get_default_edit_shortcuts = function get_default_edit_shortcuts() {
    return {
      ...
      'cmdtrl-shift-c': 'vim-binding:change-cell-to-code',
      'cmdtrl-shift-m': 'vim-binding:change-cell-to-markdown',
      'cmdtrl-shift-r': 'vim-binding:change-cell-to-raw',
      'cmdtrl-shift-p': 'jupyter-notebook:show-command-palette',
      // Repeat operations
      'ctrl-y': 'vim-binding:scroll-up',
      'ctrl-e': 'vim-binding:scroll-down',
      'ctrl-u': 'vim-binding:select-previous-cell-eval-markdown',
      'ctrl-d': 'vim-binding:select-next-cell-eval-markdown',
      'ctrl-shift-u': 'vim-binding:extend-selection-above',
      'ctrl-shift-d': 'vim-binding:extend-selection-below',
      // 'ctrl-u': 'vim-binding:scroll-notebook-up',
      // 'ctrl-d': 'vim-binding:scroll-notebook-down',
